...
from app.kit.db.models.base import Model
from app.kit.db.postgres import AsyncReadSession
from app.kit.schemas import ClassName, Schema
...
async def get_pagination_params(
    ...
    limit: int = Query(
        ...
        description=(
            ...
            f"Maximum is {app_settings.API_PAGINATION_MAX_LIMIT}."
        ),
        gt=0,
    ),
) -> PaginationParams:
    return PaginationParams(page, min(app_settings.API_PAGINATION_MAX_LIMIT, limit))
